...
Command: npx gltfjsx@6.2.3 public/models/revuelto.glb
...
export function Revuelto(props) {
  const { nodes, materials } = useGLTF(
    process.env.PUBLIC_URL + "/models/revuelto.glb"
  );
  const ref = useRef();
  const t1 = useRef();
...
useGLTF.preload(process.env.PUBLIC_URL + "/models/revuelto.glb");
